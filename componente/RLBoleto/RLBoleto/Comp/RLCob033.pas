...
begin
  ...
  begin
    ...
    Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,11,false,'0'); //38 a 45 - Codigo do cedente
    ...
    Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,11,false,'0'); //58 a 68 - Codigo do cedente
    ...
    begin
      ...
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,11,false,'0'); //23 a 31 - Codigo do cedente
   ...
   case sLayoutArquivo of
      laCNAB240: begin
         if (sOcorrenciaOriginal = '02') or (sOcorrenciaOriginal = '03') or (sOcorrenciaOriginal = '26') or (sOcorrenciaOriginal = '30') then begin
            case StrToInt64(sMotivoRejeicaoComando) of
