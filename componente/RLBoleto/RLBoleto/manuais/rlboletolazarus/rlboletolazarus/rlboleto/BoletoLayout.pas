...
LResources, Controls, Forms, RLPrintDialog, printers, RLReport,
RLPDFFilter, RLSaveDialog, RLPreviewForm;
type
  ...
  TLayoutBoleto = class(TForm)
    ...
    RLLabel34: TRLLabel;
    RLLabel35: TRLLabel;
    txtLocalPagamento1: TRLLabel;
    RLLabel37: TRLLabel;
    txtDataProcessamento1: TRLLabel;
    RLLabel8: TRLLabel;
    RLBand2: TRLBand;
    RLDraw29: TRLDraw;
    RLDraw39: TRLDraw;
    ...
    procedure RLMemo2AfterPrint(Sender: TObject);
    procedure txtInstrucoes2AfterPrint(Sender: TObject);
  private
...
procedure TLayoutBoleto.LayoutBoletoBeforePrint(Sender: TObject; var PrintIt:
    Boolean);
begin
printer.title:='boleto';
RLPrintDialog.PrintParams.MaxPage:=1;
end;

procedure TLayoutBoleto.RLMemo2AfterPrint(Sender: TObject);
begin

end;

procedure TLayoutBoleto.txtInstrucoes2AfterPrint(Sender: TObject);
begin
