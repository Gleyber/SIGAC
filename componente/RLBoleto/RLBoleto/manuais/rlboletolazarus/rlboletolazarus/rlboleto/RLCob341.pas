...
function TRLBanco341.GetImagem : Byte;
begin
   Result := Imagem;
end;

function TRLBanco341.GetNomeBanco : string;
begin
   Result := NomeBanco;
end;

function TRLBanco341.CalcularDigitoNossoNumero(ATitulo: TRLBTitulo) : string;
var
   ACodigoAgencia,
   ANumeroConta,
   ACarteira,
...
function TRLBanco341.GetCampoLivreCodigoBarra(ATitulo: TRLBTitulo) : string;
var
   ACarteira,
   ANossoNumero,
   ADigitoNossoNumero,
...
procedure TRLBanco341.FormatarBoleto(ATitulo: TRLBTitulo; var AAgenciaCodigoCedente, ANossoNumero, ACarteira, AEspecieDocumento: string);
begin
  with ATitulo do
  begin
...
function TRLBanco341.GerarRemessaCNAB400(var ACobranca: TRLBRemessa; var Remessa: TStringList) : boolean;
var
...
//            toRemessaBaixarPagoCedente: ATipoOcorrencia := '34';
         ...
         Registro := Registro + Formatar('',34,true,' '); // NOME DO SACADOR/AVALISTA
...
function TRLBanco341.GerarRemessa(var ACobranca: TRLBRemessa; var Remessa: TStringList) : boolean;
begin
...
function TRLBanco341.LerRetornoCNAB400(var ACobranca: TRLBRemessa; Retorno: TStringList) : boolean;
var
  ACodigoBanco,
  ANomeCedente,
      ...
      begin
        ...
        begin
          {Dados do cedente do título}
           ...
           //Banco Itáu separa valor de tarifa de cobranca do valor recebido
           ValorRecebido  := ValorRecebido + ValorDespesaCobranca;
           ...
           if Trim(Copy(Retorno.Strings[NumeroRegistro],296,6)) <> '' then
           begin
...
function TRLBanco341.LerRetorno(var ACobranca: TRLBRemessa; Retorno: TStringList) : boolean;
var
  ACodigoBanco,
  ANomeCedente,
  ATipoInscricao : string;
...
function TRLBanco341.VerificaOcorrenciaOriginal(sOcorrenciaOriginal: String): String;
begin
...
function TRLBanco341.VerificaMotivoRejeicaoComando(sMotivoRejeicaoComando: String): String;
var
 i: Integer;
begin
 Result:='';
