...
function TRLBanco000.GetImagem: Byte;
begin
   Result := Imagem;
end;

function TRLBanco000.GetNomeBanco : string;
begin
   Result := NomeBanco;
end;

function TRLBanco000.CalcularDigitoNossoNumero(ATitulo: TRLBTitulo) : string;
var
   ACodigoAgencia,
   ANumeroConta,
   ACarteira,
...
function TRLBanco000.GetCampoLivreCodigoBarra(ATitulo: TRLBTitulo) : string;
var
   ACarteira,
   ANossoNumero,
   ADigitoNossoNumero,
...
procedure TRLBanco000.FormatarBoleto(ATitulo: TRLBTitulo; var AAgenciaCodigoCedente, ANossoNumero, ACarteira, AEspecieDocumento: string);
begin
  with ATitulo do
  begin
...
function TRLBanco000.GerarRemessaCNAB400(var ACobranca: TRLBRemessa; var Remessa: TStringList) : boolean;
var
...
function TRLBanco000.GerarRemessa(var ACobranca: TRLBRemessa; var Remessa: TStringList) : boolean;
begin
...
function TRLBanco000.LerRetornoCNAB400(var ACobranca: TRLBRemessa; Retorno: TStringList) : boolean;
var
  ACodigoBanco,
  ANomeCedente,
...
function TRLBanco000.LerRetorno(var ACobranca: TRLBRemessa; Retorno: TStringList) : boolean;
var
  ACodigoBanco,
  ANomeCedente,
  ATipoInscricao : string;
...
function TRLBanco000.VerificaOcorrenciaOriginal(sOcorrenciaOriginal: String): String;
begin
...
function TRLBanco000.VerificaMotivoRejeicaoComando(sMotivoRejeicaoComando: String): String;
var
 i: Integer;
begin
 Result:='';
