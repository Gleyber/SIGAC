...
function TRLBanco275.GetImagem : Byte;
begin
   Result := Imagem;
end;

function TRLBanco275.GetNomeBanco : string;
begin
   Result := NomeBanco;
end;

function TRLBanco275.CalcularDigitoNossoNumero(ATitulo: TRLBTitulo) : string;
var
   ACodigoAgencia,
   ANumeroConta,
   ANossoNumero,
...
function TRLBanco275.GetCampoLivreCodigoBarra(ATitulo: TRLBTitulo) : string;
var
   ANossoNumero,
   ACodigoAgencia,
   ANumeroConta,
...
procedure TRLBanco275.FormatarBoleto(ATitulo: TRLBTitulo; var AAgenciaCodigoCedente, ANossoNumero, ACarteira, AEspecieDocumento: string);
begin
   with ATitulo do
   begin
...
function TRLBanco275.GerarRemessa(var ACobranca: TRLBRemessa; var Remessa: TStringList) : boolean;
var
...
function TRLBanco275.LerRetorno(var ACobranca: TRLBRemessa; Retorno: TStringList) : boolean;
var
   ACodigoBanco,
   ANomeCedente,
