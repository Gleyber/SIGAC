...
uses
   classes, SysUtils, RLBoleto, Dialogs
  {$IFDEF VER150}
...
begin
  Result := '0';
  if ATitulo.Carteira = '1' then
    ANossoNumero := Formatar(ATitulo.NossoNumero,18,False,'0')
  else
...
begin
{
  ...
  begin
    ...
    ACodigoCedente := Formatar(ATitulo.Cedente.CodigoCedente,6,False,'0');
    Result := '1'+ACodigoCedente + ANossoNumero;
  end
  else
  begin
    with ATitulo do
...
begin
  ...
  begin
    ...
    begin
      ...
      ANossoNumero := Formatar(NossoNumero,18,false,'0') + '-' + DigitoNossoNumero;
      ACarteira    := 'SR';
    end
    else
    begin
      AAgenciaCodigoCedente := Formatar(Cedente.ContaBancaria.CodigoAgencia,4,false,'0') + '.' +
                               Copy(Cedente.CodigoCedente,1,3) + '.' +
                               Formatar(Copy(Cedente.CodigoCedente,4,8),8,false,'0') + '-' +
                               Cedente.DigitoCodigoCedente;
