...
type
  ...
  public
    ...
    {@method New - Adiciona página à coleção. :/}
  ...
  private
    ...
    fOpened     :boolean;
    fModified   :boolean;
    // bitmap auxiliar para cálculo de tamanho de fontes
    fBitmapAux  :TBitmap;
    // coleção de fontes
    fFonts      :TStrings;
    ...
    // força instanciação do bitmap auxiliar 
...
begin
  fMacros.Values['PaperHeight']:=FloatToPtStr(IfThen(Value<0,-1,Value));
end;
...
begin
  fMacros.Values['PaperWidth']:=FloatToPtStr(IfThen(Value<0,-1,Value));
end;
