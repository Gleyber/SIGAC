object fdm: Tfdm
  ...
  object tbquery1: TClientDataSet
    ...
    Left = 8
    Top = 134
    object tbquery1chave: TIntegerField
      FieldName = 'chave'
    end
    object tbquery1dtemissao: TDateField
      FieldName = 'dtemissao'
    end
    object tbquery1dtvencimento: TDateField
      FieldName = 'dtvencimento'
    end
    object tbquery1dtpagamento: TDateField
      FieldName = 'dtpagamento'
    end
    object tbquery1total: TFloatField
      FieldName = 'total'
    end
    object tbquery1cheque: TStringField
      FieldName = 'cheque'
    end
    object tbquery1conta: TStringField
      FieldName = 'conta'
      Size = 10
    end
    object tbquery1codigo: TIntegerField
      FieldName = 'codigo'
    end
    object tbquery1nome: TStringField
      FieldName = 'nome'
      Size = 60
    end
    object tbquery1banco: TStringField
      FieldName = 'banco'
    end
    object tbquery1agencia: TStringField
      FieldName = 'agencia'
      Size = 10
    end
  end
