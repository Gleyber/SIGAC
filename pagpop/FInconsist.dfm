object FrmInconsist: TFrmInconsist
  Left = 192
  Top = 124
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Atualiza'#231#227'o de Dados - Incosist'#234'ncia'
  ClientHeight = 302
  ClientWidth = 624
  Color = clBtnFace
  ...
  object Label1: TLabel
    ...
    Height = 49
    Caption = 
      'Foi verificado a exist'#234'ncia de dados conflitantes com da base we' +
      'b com  a base local. Verifique os dados abaixo e diga a a'#231#227'o a s' +
      'er tomada:'
    WordWrap = True
  end
  ...
  object btnInserir: TBitBtn
    ...
    Width = 185
    Height = 81
    Caption = 'Vou inserir novo registro'
    TabOrder = 1
  ...
  object btnUpdate: TBitBtn
    ...
    Width = 185
    Height = 81
    Caption = 'Vou atualizar o registro'
    TabOrder = 2
